...
- Release status: YOMUVIA 0.6.2 Public Beta is available for Windows. The public installer passed 212 automated tests plus an install-launch-uninstall smoke test. The signed auto-update manifest, licensing API, cloud AI routing, and Stripe checkout links pass production checks. The standalone installer is not yet Windows Authenticode-signed, so Microsoft Defender SmartScreen may display a warning.
