...
export const enContentPages: ContentPage[] = [
  ...
  },
  {
    ...
    description: "Pre-release terms covering the YOMUVIA software, AI features, subscriptions, and acceptable use.",
  ...
  },
  {
    ...
    lead: "YOMUVIA separates local playback and recognition from optional network services. This pre-release policy describes the implemented boundaries and launch requirements.",
    sections: [
  ...
  },
  {
    ...
    description: "YOMUVIA Pro pricing, trial, billing, delivery, and the seller fields that must be completed before checkout opens.",
